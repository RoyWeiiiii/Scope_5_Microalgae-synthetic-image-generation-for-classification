...
if __name__ == "__main__":
    ...
    parser.add_argument('--save_dir', type=str, default=os.path.join('temp', 'pixelcnn_conditional_vqvae_eval_results'), help='output results location')
    parser.add_argument('--ckpt', type=str, default=os.path.join('model_weights', 'pixelcnn_conditional_vqvae', 'models', '20000.pth'), help='checkpoint weight path if have one')
