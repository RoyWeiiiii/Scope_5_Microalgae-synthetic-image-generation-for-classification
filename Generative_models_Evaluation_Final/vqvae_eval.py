...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_weight', type=str, default=os.path.join('model_weights', 'vqvae_results', 'models', '5000.pth'), help='Model weight path')
    parser.add_argument('--save_path', type=str, default=os.path.join('temp', 'vqvae_eval_results'), help='DEFAULT: Save generated image folder')
